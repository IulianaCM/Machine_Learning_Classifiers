...
# Initializare Naive Bayes classifier
nb_classifier = GaussianNB()

# Train the model
nb_classifier.fit(X_train, y_train)

# Predictii pe setul de date
...
# Testare și vizualizare pentru Naive-Bayes
...
for i, test_image_path in enumerate(test_image_paths):
    ...
    test_prediction = nb_classifier.predict(test_features)  # Predict classes
